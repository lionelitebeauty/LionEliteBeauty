  ...
  return (
    <div style={{ backgroundColor: '#FAF7F2', minHeight: '100vh' }}>
      ...
      <section style={{ padding: '60px 0 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'absolute', top: '-120px', right: '-80px', width: '400px', height: '400px', border: '1px solid #C9A96E15', borderRadius: '50%' }}></div>
        <div style={{ position: 'absolute', bottom: '-160px', left: '-100px', width: '500px', height: '500px', border: '1px solid #C9A96E10', borderRadius: '50%' }}></div>
        <div style={{ position: 'absolute', top: '40%', right: '15%', width: '2px', height: '120px', background: 'linear-gradient(to bottom, #C9A96E00, #C9A96E20, #C9A96E00)' }}></div>
        <div style={{ position: 'absolute', top: '30%', left: '10%', width: '2px', height: '80px', background: 'linear-gradient(to bottom, #C9A96E00, #C9A96E15, #C9A96E00)' }}></div>
        <div className="max-w-3xl mx-auto px-6 text-center" style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#4A4A4A', fontSize: '16px', lineHeight: '1.9', maxWidth: '560px', margin: '0 auto 32px' }}>
          ...
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', backgroundColor: '#FFFFFF', border: '1px solid #E0D5C5', padding: '10px 18px' }}>
            <div style={{ width: '5px', height: '5px', backgroundColor: '#C9A96E', borderRadius: '50%' }}></div>
            <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '12px', letterSpacing: '0.08em' }}>
      ...
      <section style={{ padding: '0 0 80px' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div style={{
            backgroundColor: '#FFFFFF', border: '1px solid #8A9E85',
            ...
            <div style={{ flex: '1', minWidth: '280px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
                <span style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A9E85', fontSize: '9px', letterSpacing: '0.25em', padding: '4px 10px', border: '1px solid #8A9E85' }} className="uppercase">Starter Program</span>
                <span style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '9px', letterSpacing: '0.2em' }} className="uppercase">$299.99 / month</span>
              </div>
              <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.6rem', marginBottom: '8px' }} className="font-normal">
                Foundation Coaching
              </h2>
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '13px', lineHeight: '1.8', marginBottom: '16px', maxWidth: '480px' }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '6px', marginBottom: '20px' }}>
                {['Monthly coaching call', 'Wellness roadmap', 'Peptide education', 'Email support', 'Progress tracking'].map(f => (
                  <span key={f} style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', fontSize: '10px', color: '#8A9E85', letterSpacing: '0.05em', backgroundColor: '#F8FAF7', padding: '6px 12px', border: '1px solid #D5E0D0' }}>{f}</span>
                ))}
              </div>
            ...
            <div style={{ textAlign: 'right', flexShrink: 0 }}>
              ...
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.15em' }}>/ MONTH</p>
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#9A9A9A', fontSize: '11px', marginTop: '16px', lineHeight: '1.6' }}>
            ...
            {allPrograms.map((p) => (
              <div key={p.id} style={{ backgroundColor: p.bg, border: `1px solid ${p.border}`, display: 'flex', flexDirection: 'column' }}>
                <div style={{ padding: '40px 36px 28px', flex: 1 }}>
                  ...
                  <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.3rem', lineHeight: '1.3', marginBottom: '12px' }} className="font-normal">
                    {p.label}
                  </h2>
                  <div style={{ width: '24px', height: '1px', backgroundColor: p.accent, marginBottom: '16px' }}></div>
                  <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '11px', letterSpacing: '0.08em', marginBottom: '8px' }} className="uppercase">
                    Best For
                  </p>
                  <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#4A4A4A', fontSize: '13px', lineHeight: '1.7', marginBottom: '20px' }}>
                    {p.bestFor}
                  </p>
                  <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '11px', letterSpacing: '0.08em', marginBottom: '10px' }} className="uppercase">
                    Key Outcomes
                  </p>
                  <div className="space-y-1.5 mb-6">
                    {p.fixes.map(f => (
                      <div key={f} className="flex items-center gap-2">
                        ...
                        <span style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#4A4A4A', fontSize: '12px' }}>{f}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section style={{ backgroundColor: '#F5F0E8', borderTop: '1px solid #E0D5C5', padding: '80px 0' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '2rem' }} className="font-normal">
              Find the Right Fit
            </h2>
          </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid #E0D5C5' }}>
                  <th style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '10px', letterSpacing: '0.2em', padding: '16px 20px', textAlign: 'left', fontWeight: 400 }} className="uppercase">Program</th>
                  <th style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '10px', letterSpacing: '0.2em', padding: '16px 20px', textAlign: 'left', fontWeight: 400 }} className="uppercase">Best For</th>
                  <th style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '10px', letterSpacing: '0.2em', padding: '16px 20px', textAlign: 'left', fontWeight: 400 }} className="uppercase">Primary Outcome</th>
                  <th style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '10px', letterSpacing: '0.2em', padding: '16px 20px', textAlign: 'left', fontWeight: 400 }} className="uppercase">Timeline</th>
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.label} style={{ borderBottom: '1px solid #E0D5C5', backgroundColor: i % 2 === 0 ? '#FFFFFF' : '#FAF7F2' }}>
                    <td style={{ padding: '18px 20px' }}>
                      <div className="flex items-center gap-3">
                        <div style={{ width: '7px', height: '7px', backgroundColor: row.accent, borderRadius: '50%', flexShrink: 0 }}></div>
                        <span style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '14px' }}>{row.label}</span>
                      </div>
                    </td>
                    <td style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#4A4A4A', fontSize: '13px', padding: '18px 20px' }}>{row.bestFor}</td>
                    <td style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#4A4A4A', fontSize: '13px', padding: '18px 20px' }}>{row.outcome}</td>
          ...
          <div className="md:hidden space-y-3">
            <div key="foundation" style={{ backgroundColor: '#FFFFFF', border: '1px solid #8A9E85', padding: '20px 24px' }}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div style={{ width: '7px', height: '7px', backgroundColor: '#8A9E85', borderRadius: '50%' }}></div>
                  <div>
                    <span style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '14px' }}>Foundation Coaching</span>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.1em' }}>$299.99/month · Starter</p>
                  </div>
                </div>
                <Link to="/apply?program=foundation"
            ...
            {allPrograms.map(p => (
              <div key={p.id} style={{ backgroundColor: '#FFFFFF', border: `1px solid ${p.border}`, padding: '20px 24px' }}>
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div style={{ width: '7px', height: '7px', backgroundColor: p.accent, borderRadius: '50%' }}></div>
                    <span style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '14px' }}>{p.label}</span>
                  </div>
                  <Link to={`/apply?program=${p.id}`}
      ...
      <section style={{ backgroundColor: '#FAF7F2', padding: '80px 0', borderTop: '1px solid #E8DDD0' }}>
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '2rem' }} className="font-normal">How You Get Started</h2>
          </div>
          <div className="grid md:grid-cols-5 gap-0">
            {[
              ...
              <div key={step.num} style={{ padding: '36px 28px', borderLeft: i === 0 ? '1px solid #E0D5C5' : 'none', borderRight: '1px solid #E0D5C5', borderTop: '1px solid #E0D5C5', borderBottom: '1px solid #E0D5C5', position: 'relative', backgroundColor: '#FFFFFF' }}>
                <p style={{ fontFamily: 'Georgia, serif', color: '#F0EAE0', fontSize: '4rem', position: 'absolute', bottom: '12px', right: '16px', lineHeight: '1', userSelect: 'none' }}>{step.num}</p>
                ...
                <p style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.1rem', marginBottom: '10px' }} className="font-normal">{step.title}</p>
                <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '12px', lineHeight: '1.8' }}>{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* CTA */}
      <section style={{ backgroundColor: '#F5F0E8', padding: '100px 0', borderTop: '1px solid #E0D5C5' }}>
        <div className="max-w-2xl mx-auto px-6 text-center">
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '2.6rem', lineHeight: '1.12', marginBottom: '20px' }} className="font-normal">
          ...
          <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '15px', lineHeight: '1.9', marginBottom: '40px' }}>
