...
export default function SkinSystemPage() {
  ...
  return (
    <div style={{ backgroundColor: '#FAF7F2', minHeight: '100vh' }}>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-end">
            <div>
              ...
              <h1 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '3.4rem', lineHeight: '1.1', letterSpacing: '-0.02em' }}
              ...
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '17px', lineHeight: '1.85' }}>
            ...
            <div>
              {/* Stats strip */}
              <div className="grid grid-cols-2 gap-px" style={{ backgroundColor: '#E0D5C5' }}>
                {[
                  ...
                  <div key={s.label} style={{ backgroundColor: '#FFFFFF', padding: '28px 24px' }}>
                    <p style={{ fontFamily: 'Georgia, serif', color: '#C9A96E', fontSize: '2rem', marginBottom: '6px' }}>{s.stat}</p>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '11px', letterSpacing: '0.1em', lineHeight: '1.5' }} className="uppercase">{s.label}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* This is for you if */}
      <section style={{ backgroundColor: '#F5F0E8', padding: '80px 0', borderBottom: '1px solid #E8DDD0' }}>
        <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '15px', lineHeight: '1.75' }}>{point}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      {/* The 3-Step System */}
      <section style={{ backgroundColor: '#FAF7F2', padding: '80px 0', borderBottom: '1px solid #E8DDD0' }}>
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mb-16">
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '2.4rem', lineHeight: '1.1' }}
              className="font-normal">
              Three steps. Use daily.<br />Don't skip either session.
            </h2>
          </div>

          <div className="space-y-px" style={{ backgroundColor: '#E0D5C5' }}>
            {steps.map((s) => (
              <div key={s.number} style={{ backgroundColor: '#FFFFFF' }}>
                <div className="grid md:grid-cols-5 gap-0">

                  {/* Step marker */}
                  <div style={{ padding: '48px 40px', borderRight: '1px solid #E0D5C5', display: 'flex', flexDirection: 'column', justifyContent: 'flex-start' }}>
                    ...
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '11px', marginTop: '8px', lineHeight: '1.6' }}>{s.directive}</p>
                  </div>

                  {/* Product info */}
                  <div className="md:col-span-2" style={{ padding: '48px 40px', borderRight: '1px solid #E0D5C5' }}>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.18em', marginBottom: '12px' }} className="uppercase">Product</p>
                    <h3 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.3rem', lineHeight: '1.3', marginBottom: '10px' }}>
                      {s.product}
                    </h3>
                    ...
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '12px', marginBottom: '20px' }}>{s.price} · {s.size}</p>
                  ...
                  {/* How to use */}
                  <div style={{ padding: '48px 40px', borderRight: '1px solid #E0D5C5' }}>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.18em', marginBottom: '12px' }} className="uppercase">How to Use It</p>
                    <p style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '14px', lineHeight: '1.7', fontStyle: 'italic' }}>
                      "{s.instruction}"
                    </p>
                  </div>
                  ...
                  <div style={{ padding: '48px 40px' }}>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.18em', marginBottom: '12px' }} className="uppercase">Why It's Here</p>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '13px', lineHeight: '1.85' }}>{s.why}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          {/* Evening add-on */}
          <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E0D5C5', marginTop: '1px', padding: '36px 40px' }}
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#8A8A8A', fontSize: '10px', letterSpacing: '0.15em' }} className="uppercase">Optional · Highly Recommended</p>
              </div>
              <h3 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.2rem', marginBottom: '10px' }}>Add the Collagen Boost Face Cream on evenings.</h3>
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '14px', lineHeight: '1.8', maxWidth: '560px' }}>
            ...
            <div className="flex flex-col items-start gap-3 flex-shrink-0">
              <p style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.3rem' }}>$99.99 <span style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '12px' }}>· 50ml</span></p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-px" style={{ backgroundColor: '#E0D5C5' }}>
            {[
              ...
              <div key={t.period} style={{ backgroundColor: '#FFFFFF', padding: '48px 40px' }}>
                ...
                <h3 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '1.1rem', lineHeight: '1.4', marginBottom: '24px' }}>{t.headline}</h3>
                ...
                <ul className="space-y-4">
                  {t.points.map(p => (
                    <li key={p} className="flex items-start gap-3">
                      ...
                      <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '13px', lineHeight: '1.7' }}>{p}</p>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div style={{ backgroundColor: '#FFFFFF', border: '1px solid #E0D5C5', marginTop: '1px', padding: '28px 40px' }}
      ...
      {/* CTA */}
      <section style={{ backgroundColor: '#FAF7F2', padding: '100px 0' }}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            <div>
              ...
              <h2 style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '2.6rem', lineHeight: '1.1', marginBottom: '24px' }}
                className="font-normal">
                Start your skin system.<br />Use it daily.<br />Watch it work.
              </h2>
              <div style={{ width: '48px', height: '1px', backgroundColor: '#C9A96E', marginBottom: '28px' }}></div>
              <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '15px', lineHeight: '1.9', marginBottom: '36px', maxWidth: '440px' }}>
            ...
            <div className="space-y-px" style={{ backgroundColor: '#E0D5C5' }}>
              {[
                ...
                <div key={p.slug} style={{ backgroundColor: '#FFFFFF', padding: '24px 32px' }}
                  ...
                  <div>
                    ...
                    <p style={{ fontFamily: 'Georgia, serif', color: '#2A2A2A', fontSize: '14px' }}>{p.name}</p>
                    <p style={{ fontFamily: 'Helvetica Neue, Arial, sans-serif', color: '#6A6A6A', fontSize: '11px', marginTop: '4px' }}>{p.price} · {p.size}</p>
                  </div>
